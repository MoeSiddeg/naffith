...
import 'package:naffith/presentation/screens/my_advertisements_buy_info/logic/delete_real_estate_state.dart';
import '../../application/application_page.dart';


class DeleteRealEstateBlocListener extends StatelessWidget {
  const DeleteRealEstateBlocListener({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocListener<DeleteRealEstateCubit, DeleteRealEstateState>(

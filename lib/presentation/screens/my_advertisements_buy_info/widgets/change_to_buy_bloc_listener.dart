...
import 'package:naffith/presentation/screens/my_advertisements_buy_info/logic/change_to_buy/change_to_buy_state.dart';

class ChangeToBuyBlocListener extends StatelessWidget {
  String id;
   ChangeToBuyBlocListener({super.key, required this.id});

  @override
  Widget build(BuildContext context) {
    return BlocListener<ChangeToBuyCubit, ChangeToBuyStates>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                'تم تغيير الاعلان الى طلب بنجاح',
                style: GoogleFonts.almarai(
                  textStyle: TextStyle(
                    color: const Color.fromRGBO(23, 56, 61, 1),
                    letterSpacing: 0,

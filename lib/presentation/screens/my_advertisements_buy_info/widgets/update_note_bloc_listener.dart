...
class UpdateNoteBlocListener extends StatelessWidget {
  const UpdateNoteBlocListener({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocListener<UpdateNoteCubit, UpdateNoteStates>(
      ...
      builder: (context) => AlertDialog(
        ...
        Column(
          ...
          children: [
            ...
            Text(
              'حدث حطأ ما الرجاء المحاولة مرة اخرى',

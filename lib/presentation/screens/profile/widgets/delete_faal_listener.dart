...
import '../logic/delete_faal_cubit.dart';
import '../logic/delete_faal_states.dart';

class DeleteFaalBlocListener extends StatelessWidget {
  const DeleteFaalBlocListener({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocListener<DeleteFaalCubit, DeleteFaalStates>(

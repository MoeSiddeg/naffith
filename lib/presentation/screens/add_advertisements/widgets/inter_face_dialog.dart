...
class InterfaceListAlertDialog extends StatefulWidget {
  final List<String> stringList;
  final String title;
  List<String> selectedItems;

  InterfaceListAlertDialog({required this.stringList, required this.title , required this.selectedItems});

  @override
  _InterfaceListAlertDialogState createState() => _InterfaceListAlertDialogState();
}

class _InterfaceListAlertDialogState extends State<InterfaceListAlertDialog> {

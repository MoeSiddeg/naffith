...
import 'widgets/multi_selection_widget.dart';
...
////////////////////////////////////////////
  ...
  final MultiSelectController<ValueItem> _tamoylController =
      MultiSelectController<ValueItem>();

  final List<ValueItem> _selectedOptionsTamoyl = [];
  List<String> _selectedItemsTamoyl = [];
  final MultiSelectController<ValueItem> _wajahController =
      MultiSelectController<ValueItem>();
              ...
              Row(
                ...
                children: [
                  PropertyTypeDropdown(
                    ...
                    items: ageList(),
                    textWidgetString: 'عمر العقار بالسنة',
                    onChanged: (String? value) {
                      setState(() {
                        selectedAge = value;
                      });
                ...
                children: [
                  PropertyTypeDropdown(
                    ...
                    onChanged: (String? value) {
                      setState(() {
                        selectedArea = value;
                        areaAsNumber = extractNumbers(selectedArea!);
                        print(areaAsNumber);
                      });
                    },
                  ),
        ...
        child: Form(
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    PropertyTypeDropdown(
                      textWidgetString: 'عدد الادوار',
                      items: floorGenerateList(),
                      selectedValue: selectedFloorNumber,
                      onChanged: (value) {
                        setState(() {
              ...
              Padding(
                padding: EdgeInsets.only(top: 1.h, bottom: 15.h),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    PropertyTypeDropdown(
              ...
              ReusablePropertyField(
                ...
                hint: 'الملاحظات',
                padding: EdgeInsets.only(
                    right: 5.h, left: 10.h, bottom: 5.h, top: 5.h),

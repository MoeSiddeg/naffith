...
class ReportRealEstatesBlocListener extends StatelessWidget {
  const ReportRealEstatesBlocListener({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocListener<ReportRealEstatesCubit, ReportRealEstateState>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                'تم رفع البلاغ ستقوم الإدارة بمراجعته',
                style: GoogleFonts.almarai(
                  textStyle: TextStyle(
                    color: const Color.fromRGBO(23, 56, 61, 1),
                    letterSpacing: 0,
